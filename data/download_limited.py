...
def main():
    ...
    for folder in date_folders:
        ...
        # Limit to 20 files per data directory
        lbl_files_to_download = lbl_files[:20]
        print(f"  -> Found {len(lbl_files)} .lbl files in data/. Downloading exactly {len(lbl_files_to_download)}...")
        ...
        # 2. Process the index/ directory (these are tiny, so we download them all for metadata)
